...
Процедура ОбновитьДанные(Форма = Неопределено) Экспорт
	...
	|			И (ВыбранныеПодразделения.КодПоОКТМО <> &ПустойКодПоОКАТО)
	...
	|ГДЕ
	|	ПодразделенияОрганизаций.КодПоОКТМО = &ПустойКодПоОКАТО
	|	И ПодразделенияОрганизаций.КодПоОКАТО <> &ПустойКодПоОКАТО
	|	И ТаблицаСоответствияКодов.Отметка
	|	И ТаблицаСоответствияКодов.КодПоОКТМО <> &ПустойКодПоОКАТО
	...
	|		И ТаблицаПодразделений.КодПоОКТМО <> &ПустойКодПоОКАТО
	...
	|			ИЗ
	|				ВТРегистраторыКОбработке КАК РегистраторыКОбработке)
	|	И ПОДСТРОКА(СправкаПоНДФЛВНалоговыйОрган.ОКТМО_КПП, 1, 11) = &ПустойКодПоОКАТО";
	...
	|			ИЗ
	|				ВТРегистраторыКОбработке КАК РегистраторыКОбработке)
	|	И СтрокиРегистра.КодПоОКТМО = &ПустойКодПоОКАТО
	...
	|			ИЗ
	|				ВТРегистраторыКОбработке КАК РегистраторыКОбработке)
	|	И ПОДСТРОКА(СтрокиРегистра.ОКТМО_КПП, 1, 11) = &ПустойКодПоОКАТО
	|	И СоответствиеОКАТОиОКТМО.КодПоОКАТО ЕСТЬ НЕ NULL 
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	...
	|	ВЫБОР
	|		КОГДА ПОДСТРОКА(РасчетыНалоговыхАгентовСБюджетомПоНДФЛ.ОКТМО_КПП, 1, 11) = &ПустойКодПоОКАТО
	...
	|			ИЗ
	|				ВТРегистраторыКОбработке КАК РегистраторыКОбработке)
	|	И СтрокиДокумента.КодПоОКТМО = &ПустойКодПоОКАТО
	|	И СоответствиеОКАТОиОКТМО.КодПоОКАТО ЕСТЬ НЕ NULL 
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	...
	|	ВЫБОР
	|		КОГДА НДФЛВозвратНалогаРаботникиОрганизации.КодПоОКТМО = &ПустойКодПоОКАТО
	|			ТОГДА СоответствиеОКАТОиОКТМО.КодПоОКТМО
	...
	|	ВЫБОР
	|		КОГДА НДФЛиЕСНДоходыИНалогиНДФЛСведенияОДоходах.КодПоОКТМО = &ПустойКодПоОКАТО
	|			ТОГДА СоответствиеОКАТОиОКТМО.КодПоОКТМО
	...
	|	ВЫБОР
	|		КОГДА НДФЛиЕСНДоходыИНалогиНДФЛИсчисленный13.КодПоОКТМО = &ПустойКодПоОКАТО
	|			ТОГДА СоответствиеОКАТОиОКТМО.КодПоОКТМО
	...
	|	ВЫБОР
	|		КОГДА НДФЛиЕСНДоходыИНалогиНДФЛПредоставленныеВычеты.КодПоОКТМО = &ПустойКодПоОКАТО
	|			ТОГДА СоответствиеОКАТОиОКТМО.КодПоОКТМО
	...
	|	ВЫБОР
	|		КОГДА НДФЛиЕСНДоходыИНалогиНДФЛУдержанный.КодПоОКТМО = &ПустойКодПоОКАТО
	|			ТОГДА СоответствиеОКАТОиОКТМО.КодПоОКТМО
