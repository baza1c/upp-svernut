...
Процедура СохранитьПакетыЭДНаДиск(Команда)
	...
	мПрисоединенныеФайлы = ПолучитьПрисоединенныеФайлыПакетовЭДНаСервере(Элементы.ВсеПакеты.ВыделенныеСтроки);
	
	Для каждого ПрисоединенныйФайл Из мПрисоединенныеФайлы Цикл
