...
Процедура ЗаполнитьПостроительОтчетаПоЦенеПоступления(ВключатьНезаполненные, ЗаполнятьТолькоТекстЗапроса) Экспорт
         ТекстЗапроса = "ВЫБРАТЬ
                        ...
                        |	Лео_ПартияНоменклатурыСрезПоследних.Цена КАК Цена,
                        ...
                        |	Лео_ПартияНоменклатурыСрезПоследних.Номенклатура.ЭтоГруппа КАК ЭтоГруппа,
                        |	Лео_ПартияНоменклатурыСрезПоследних.Номенклатура.Родитель КАК Родитель,
                        |	Лео_ПартияНоменклатурыСрезПоследних.Номенклатура.ЕдиницаХраненияОстатков КАК ЕдиницаИзмерения,
                        ...
                        |	РегистрСведений.Лео_ПартияНоменклатуры.СрезПоследних(&ДатаЦенСкидок, ) КАК Лео_ПартияНоменклатурыСрезПоследних,
                        |	Справочник.ТипыЦенНоменклатуры КАК ТипыЦенНоменклатуры
                        |{ГДЕ
                        |	Лео_ПартияНоменклатурыСрезПоследних.Номенклатура.*,
                        |	ТипыЦенНоменклатуры.Ссылка.* КАК ТипЦен,
                        |	Лео_ПартияНоменклатурыСрезПоследних.Номенклатура.Родитель.* КАК Папка}
                        |
                        |СГРУППИРОВАТЬ ПО
                        |	Константы.ВалютаУправленческогоУчета,
                        |	Лео_ПартияНоменклатурыСрезПоследних.Номенклатура,
                        |	ТипыЦенНоменклатуры.Ссылка,
                        |	Лео_ПартияНоменклатурыСрезПоследних.Номенклатура.ЭтоГруппа,
                        |	Лео_ПартияНоменклатурыСрезПоследних.Номенклатура.Родитель,
                        |	Лео_ПартияНоменклатурыСрезПоследних.Номенклатура.ЕдиницаХраненияОстатков,
                        |	ТипыЦенНоменклатуры.СпособРасчетаЦены,
                        |	ТипыЦенНоменклатуры.ПроцентСкидкиНаценки,
	...
	Если Не ЗаполнятьТолькоТекстЗапроса Тогда
		...
		Попытка
		    ЭлементОтбора = ПостроительОтчета.Отбор.Добавить("Папка",, "Папка");
			ЭлементОтбора.ВидСравнения  = ВидСравнения.НеВИерархии;
			ЭлементОтбора.Значение = Справочники.Номенклатура.НайтиПоНаименованию("АРХИВ",Истина,справочники.Номенклатура.ПустаяСсылка());  //Архив
			ЭлементОтбора.Использование = Истина;
