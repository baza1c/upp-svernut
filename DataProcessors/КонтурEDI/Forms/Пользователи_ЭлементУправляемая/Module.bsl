...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Попытка
		...
		КонецЕсли;
	Исключение
		МодульОбъекта().ЗаписьЖурналаРегистрации_КонтурEDI(УровеньЖурналаРегистрации.Предупреждение, "Не удалось определить имя файла модуля - " + ОписаниеОшибки());	
	КонецПопытки;
...
Процедура ПриОткрытии(Отказ)
	...
	ОсновнаяФорма().ПриОткрытииФормы(ЭтаФорма, "Пользователи_ЭлементУправляемая");
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	ОсновнаяФорма().ПриЗакрытииФормы(ЭтаФорма, "Пользователи_ЭлементУправляемая");	
