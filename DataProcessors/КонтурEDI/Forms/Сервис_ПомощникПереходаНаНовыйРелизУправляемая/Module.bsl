...
Процедура СконвертироватьНаСервере()
	...
	Исключение
		...
		ТекстОшибки = "Не сконвертировать настройки при переходе на новую версию - " + ОписаниеОшибки();
...
Процедура ПриОткрытии(Отказ)
	...
	ОсновнаяФорма().ПриОткрытииФормы(ЭтаФорма, "Сервис_ПомощникПереходаНаНовыйРелизУправляемая");
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	ОсновнаяФорма().ПриЗакрытииФормы(ЭтаФорма, "Сервис_ПомощникПереходаНаНовыйРелизУправляемая");		
