...
Процедура ВыгрузитьДанные(Команда)
	 ...
	 Если 0 + Лев(ТекущаяДата(),2) <= 5 Тогда
		...
		ОтчетДебеторка = Отчеты.лео_ПродажиТопыркин_ОдинФайл.Создать();
		...
		ИмяДокумента = "Prodaji_" + Формат(ДобавитьМесяц(ТекущаяДата(),-3), "ДФ=yyyyMM")+ ".xls";
		ТабличныйДокумент.Записать("\\air\sales\cube\1С\"+ ИмяДокумента,ТипФайлаТабличногоДокумента.XLS);
	...
	Если 0 + Лев(ТекущаяДата(),2) > 5 Тогда
		...
		ИмяДокумента = "Prodaji_" + Формат(ДобавитьМесяц(ТекущаяДата(),-2), "ДФ=yyyyMM")+ ".xls";
		ТабличныйДокумент.Записать("\\air\sales\cube\1С\"+ ИмяДокумента,ТипФайлаТабличногоДокумента.XLS);
