...
Процедура ЗаполнитьСтрокуКнигиПокупок(Секция, ЗаписьКниги, ЕстьЗаписиПоКолонке20)
	...
	Секция.Параметры.СуммаБезНДС5 = 	ЗаписьКниги.СуммаБезНДС5;
	Секция.Параметры.НДС5 = 			ЗаписьКниги.НДС5;
	Секция.Параметры.СуммаБезНДС7 = 	ЗаписьКниги.СуммаБезНДС7;
	Секция.Параметры.НДС7 = 			ЗаписьКниги.НДС7;
	...
	Для Каждого ИтогПоПериодам ИЗ ДеревоЗаписей.Строки Цикл;
		...
		Для Каждого ИтогПоПериодамКорректировки ИЗ ИтогПоПериодам.Строки Цикл;
			...
			Иначе
	            ...
	            ИтогЗаПериод.Вставить("СуммаБезНДС5", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 2)));
				ИтогЗаПериод.Вставить("НДС5", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 2)));
	            ИтогЗаПериод.Вставить("СуммаБезНДС7", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 2)));
				ИтогЗаПериод.Вставить("НДС7", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 2)));
