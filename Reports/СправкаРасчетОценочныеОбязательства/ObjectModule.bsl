...
Функция ПолучитьВнешнийНаборДанных()
	...
	ТаблицаОтражения.Свернуть("ВидРасчета,ПроцентОтчислений","РазмерОтчислений,РазмерОтчисленийФССНесчастныеСлучаи,РазмерОтчисленийВзносы,Результат,РезультатВзносы");
