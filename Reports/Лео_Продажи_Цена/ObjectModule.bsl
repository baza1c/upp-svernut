...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	//{Лео Катанович
	УниверсальныйОтчет.ДобавитьПолеГруппировка("НоменклатураЕдиницаХраненияОстатковКоэффициент", "Номенклатура", "ЕдиницаХраненияОстатков.Коэффициент", "НоменклатураЕдиницаХраненияОстатковКоэффициент");
    //Лео Катанович}
	...
	//// {ZAA
	//УниверсальныйОтчет.ДобавитьПолеРесурс("ЦенаБезНДС",             "(СтоимостьОборот - НДСОборот)/(КоличествоОборот * Номенклатура.ЕдиницаХраненияОстатков.Коэффициент)", "Цена (без НДС)");
	//УниверсальныйОтчет.ДобавитьПолеРесурс("ЦенаСНДС",               "СтоимостьОборот /(КоличествоОборот * Номенклатура.ЕдиницаХраненияОстатков.Коэффициент)", "Цена (с НДС)");
	...
	//{Лео Катанович
	УниверсальныйОтчет.ДобавитьПолеРесурс("ЦенаБезНДС",             "(СтоимостьОборот - НДСОборот)/(КоличествоОборот * Номенклатура.ЕдиницаХраненияОстатков.Коэффициент)", "Цена (без НДС)",
	"Сумма(СтоимостьОборот-НДСОборот)/Сумма(КоличествоОборот * Номенклатура.ЕдиницаХраненияОстатков.Коэффициент)");
	УниверсальныйОтчет.ДобавитьПолеРесурс("ЦенаСНДС",               "СтоимостьОборот /(КоличествоОборот * Номенклатура.ЕдиницаХраненияОстатков.Коэффициент)", "Цена (с НДС)",
	"Сумма(СтоимостьОборот)/Сумма(КоличествоОборот * Номенклатура.ЕдиницаХраненияОстатков.Коэффициент)");
    //Лео Катанович}
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ЦенаБезНДС", "Цена (без НДС) в " + ВалютаУпр,		Истина, "ЧЦ=15; ЧДЦ=4");
	УниверсальныйОтчет.ДобавитьПоказатель("ЦенаСНДС",   "Цена (с НДС) в " + ВалютаУпр,		Истина, "ЧЦ=15; ЧДЦ=4");
	...
	//{Лео Катанович
	УниверсальныйОтчет.ДобавитьДополнительноеПоле("НоменклатураЕдиницаХраненияОстатковКоэффициент");
	//Лео Катанович}
