...
Процедура УстановитьНачальныеНастройкиПоМетаданнымРегистра(ИмяРегистра)
	...
	Если ИспользоватьСвойстваИКатегории Тогда
		...
		//+Лео Сафонов ЕА
		ДобавитьКонтактнуюИнформацияДляПоля("ИсточникДанных.Контрагент", "Контрагент" , "Контрагент", Перечисления.ВидыОбъектовКонтактнойИнформации.Контрагенты, "Справочник.Контрагенты");
		ДобавитьВТекстЗапросаКонтактнуюИнформацию (ТекстЗапроса);
		//-Лео Сафонов ЕА
