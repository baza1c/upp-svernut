...
Процедура СформироватьНастройкиОтчета(МассивОтбора,СтруктураПредставлениеПолей)
	...
	ТекстЗапроса="ВЫБРАТЬ РАЗРЕШЕННЫЕ
	             ...
	             |	КонтролируемыеЗначенияБюджетовОбороты.абс_Организация.* КАК Организация}
	             |ИЗ
	             ...
	             |			И УстановкаОграниченийПоБюджетам.абс_Организация = КонтролируемыеЗначенияБюджетовОбороты.абс_Организация
	             |ГДЕ
	             |	УстановкаОграниченийПоБюджетам.Период = &ДатаОтчета
	             ...
	             |	КонтролируемыеЗначенияБюджетовОбороты.абс_Организация КАК Организация}
	             |ИТОГИ
	             |	СУММА(СуммаСценарияКонтроль),
	             |	СУММА(СуммаСценарияИсполнение),
	             |	СУММА(СуммаСценарияОстаток)
	             |ПО
	             |	КонтролирующийСценарий КАК КонтролирующийСценарий,
	             |	КонтролируемыйПериод КАК КонтролируемыйПериод,
