Процедура СформироватьОтчет() Экспорт
	...
	// Коммерческий, Специализировынный ассортимент
	        ТЗкоммерческийАссортимент.Свернуть(,"СуммаКварталПрошлогоГода,СуммаМесяцПозаПрошлогоГода,СуммаМесяцПрошлогоГода,СуммаПланГод,СуммаПланКвартал,
			                                  |СуммаПланМесяц,СуммаПрошлыйГод,СуммаПрошлыйМесяц,СуммаСортировкиКонтрагентов,СуммаСортировкиНоменклтуры,СуммаФактГод,СуммаФактКвартал,СуммаФактМесяц");
	        ТЗспециализированныйАссортимент.Свернуть(,"СуммаКварталПрошлогоГода,СуммаМесяцПозаПрошлогоГода,СуммаМесяцПрошлогоГода,СуммаПланГод,СуммаПланКвартал,
			                                  |СуммаПланМесяц,СуммаПрошлыйГод,СуммаПрошлыйМесяц,СуммаСортировкиКонтрагентов,СуммаСортировкиНоменклтуры,СуммаФактГод,СуммаФактКвартал,СуммаФактМесяц");
...
Процедура ЗаполнитьПроценты(ОбластьМакета, ВыборкаЗапроса, ПроцентРабочихДнейМесяцЧисло, ПроцентРабочихДнейКварталЧисло, ПроцентРабочихДнейГодЧисло)
	...
	Если ПроцентМесяц<ПроцентРабочихДнейМесяцЧисло Тогда
		ОбластьМакета.Область(1,12).ЦветТекста = WebЦвета.Красный;
	КонецЕсли;
	...
	Если ПроцентКвартал<ПроцентРабочихДнейКварталЧисло Тогда
		ОбластьМакета.Область(1,15).ЦветТекста = WebЦвета.Красный;
	КонецЕсли;
