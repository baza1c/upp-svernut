...
Функция СформироватьОтчет(Результат, ДанныеРасшифровки = Неопределено, ВыводВФормуОтчета = Истина) Экспорт
	...
	Для каждого ДанныеОрганизации из ТаблицаЗначений Цикл
		КодыОрганизации = ОбщегоНазначенияЗК.ПолучитьЗначенияРеквизитов(ДанныеОрганизации.Организация,"НаименованиеПолное,КодПоОКАТО,КодПоОКПО,НаименованиеОКОПФ,КодОКОПФ,НаименованиеОКФС,КодОКФС,КодОКВЭД,НаименованиеОКВЭД,ИНН,ОГРН");
