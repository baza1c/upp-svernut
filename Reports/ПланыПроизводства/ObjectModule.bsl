...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	//АБС ИЗМЕНЕНИЕ   27.03.2014 12:45:01  Балашенко
	//добавлен Вид плана производства
	...
	ТекстЗапроса = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
	               ...
	               |	Планы.абс_ВидПланаПроизводства КАК ВидПланаПроизводства
	               |{ВЫБРАТЬ
	               |	ПериодПланирования,
	               |	Сценарий.*,
	               |	Подразделение.*,
	...
	//АБС ВСТАВКА   27.03.2014 12:44:30  Балашенко
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ВидПланаПроизводства", "Вид плана производства");
	//АБС ВСТАВКА  КОНЕЦ
