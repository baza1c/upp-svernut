...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	ТекстЗапроса = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
	               ...
	               |	ПериодГод}
	               |ИЗ
	               |	РегистрНакопления.МатериалыВПроизводстве.ОстаткиИОбороты(&ДатаНач, &ДатаКон, Регистратор , , {(Подразделение).* КАК Подразделение, (Заказ).* КАК Заказ, (Затрата).* КАК Затрата, (ХарактеристикаЗатраты).* КАК ХарактеристикаЗатраты, (СерияЗатраты).* КАК СерияЗатраты}) КАК РегМатериалы
	               |{ГДЕ
	               |	РегМатериалы.КоличествоНачальныйОстаток КАК КоличествоНачальныйОстаток,
	               |	РегМатериалы.КоличествоПриход КАК КоличествоПриход,
	               |	РегМатериалы.КоличествоРасход КАК КоличествоРасход,
