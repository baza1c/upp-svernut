...
Функция СформироватьЗапросПоМетаданным()
	...
	//АБС ВСТАВКА   19.02.2014 10:35:45  Шамов
	Если ТипДанных = "Справочники" Тогда
		Попытка
			ссПВХ = ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов[ИмяТипаДанных + "_" + ИмяОбъекта];
			ТекстЗапроса = ТекстЗапроса + "
			|{ХАРАКТЕРИСТИКИ
			|	ТИП(" + ИмяТипаДанных + "." + ИмяОбъекта + ")
			...
			|		ГДЕ
			|			СвойстваОбъектов.НазначениеСвойства = ЗНАЧЕНИЕ(ПланВидовХарактеристик.НазначенияСвойствКатегорийОбъектов." + ИмяТипаДанных + "_" + ИмяОбъекта + "))
			|	ПОЛЕКЛЮЧА Ссылка
