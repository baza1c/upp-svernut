...
Процедура ДоговорКонтрагентаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Отбор = Новый Структура("Владелец, Организация", Запись.Контрагент, ОбособленныеПодразделенияОрганизации);
...
Процедура ЗаполнитьСписокОбособленныхПодразделений()
	...
	Если ЗначениеЗаполнено(Запись.Организация) Тогда
		ОбособленныеПодразделенияОрганизации = ОбщегоНазначения.ПолучитьСписокОбособленныхПодразделенийОрганизации(Запись.Организация);
		ОбособленныеПодразделенияОрганизации.Добавить(Запись.Организация);
	КонецЕсли;
