...
Функция ПолучитьТекстЗапросаРасчетОценочныхОбязательств(ОценочныеОбязательстваПорядокРасчета) Экспорт
	...
	Иначе
		...
		|					КОГДА ВзносыДоходыБУДоходы.ОблагаетсяЕНВД
		|						ТОГДА 0
		|					ИНАЧЕ ЕСТЬNULL(ВзносыИсчисленные.ФССНесчастныеСлучаи, 0) * ВзносыДоходыБУДоходы.ДоляБУФСС * ВзносыДоходыБУДоходы.БазаФСС
		...
		|			СУММА(ЕСТЬNULL(ВзносыИсчисленные.ПФРЗаЗанятыхНаПодземныхИВредныхРаботах, 0) * ВзносыДоходыБУДоходы.ДоляБУПФР * ВзносыДоходыБУДоходы.БазаДопТарифПодземныеИВредныеРаботы) КАК ПФРЗаЗанятыхНаПодземныхИВредныхРаботах,
		|			СУММА(ЕСТЬNULL(ВзносыИсчисленные.ПФРЗаЗанятыхНаТяжелыхИПрочихРаботах, 0) * ВзносыДоходыБУДоходы.ДоляБУПФР * ВзносыДоходыБУДоходы.БазаДопТарифТяжелыеИПрочиеРаботы) КАК ПФРЗаЗанятыхНаТяжелыхИПрочихРаботах,
