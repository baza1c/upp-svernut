...
//	Результат запроса
//
Функция ПолучитьДанныеУчета2013(ВыборкаПоШапкеДокумента, ВыделятьЕНВД, СписокНачислений, ОрганичениеНаСотрудников, ЭтоОсновныеНачисления, ЭтоПервичныеНачисления)
...
КонецФункции // ПолучитьДанныеУчета2013()
...
Функция ПолучитьДанныеУчета(ВыборкаПоШапкеДокумента, ВыделятьЕНВД, СписокНачислений, ОрганичениеНаСотрудников, ЭтоОсновныеНачисления, ЭтоПервичныеНачисления)
	...
	Иначе
		Возврат ПолучитьДанныеУчета2013(ВыборкаПоШапкеДокумента, ВыделятьЕНВД, СписокНачислений, ОрганичениеНаСотрудников, ЭтоОсновныеНачисления, ЭтоПервичныеНачисления);
	КонецЕсли;
