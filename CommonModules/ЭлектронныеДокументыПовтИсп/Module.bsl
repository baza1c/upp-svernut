...
// Возвращает описание способов устранения оишибки с кодом 006
//
Функция ИсправлениеОшибки006() Экспорт
	
	ТекстСообщения = 
	НСтр("ru = 'Код ошибкии 006
	| Длина пути к файлам, распакованным из архива превышает 255 символов.
