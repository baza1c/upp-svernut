...
Функция ПредставлениеТарифаСтраховыхВзносов(ТарифСтраховыхВзносов) Экспорт
	...
	Если ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ОбщийНалоговыйРежим Тогда
		РасшифровкаТариф = "Основной тариф страховых взносов установлен статьями 12 и 58.2 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.УпрощенныйНалоговыйРежим Тогда
		РасшифровкаТариф = "С 2011 года применяются ставки основного тарифа страховых взносов, установленые статьями 12 и 58.2 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.УпрощенныйНалоговыйРежимПроизводство Тогда
		РасшифровкаТариф = "Тариф установлен на 2011-2013 годы для страхователей, удовлетворяющих условиям пункта 8 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.СельХозПроизводители Тогда
		РасшифровкаТариф = "Тариф установлен на 2010 год пунктом 1 части 2 статьи 57, на 2011-2014 годы пунктом 1 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ЕСХН Тогда
		РасшифровкаТариф = "Тариф установлен на 2010 год пунктом 3 части 2 статьи 57, на 2011-2014 годы пунктом 2 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ОрганизацияИнвалидов Тогда
		РасшифровкаТариф = "Тариф установлен на 2010 год пунктом 2 части 2 статьи 57, на 2011-2014 годы пунктом 3 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.РезидентТехникоВнедренческойЗоны Тогда
		РасшифровкаТариф = "Тариф установлен на 2010 год пунктом 2 части 2 статьи 57, на 2011-2019 годы пунктом 5 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.УчастникПроектаИнновационныйЦентрСколково Тогда
		РасшифровкаТариф = "Тариф установлен статьей 58.1 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ХозОбществаБюджетныхВУЗов Тогда
		РасшифровкаТариф = "Тариф установлен на 2011-2019 годы для хозяйственных обществ пунктом 4 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ITОрганизации Тогда
		РасшифровкаТариф = "Тариф установлен на 2010 год пунктом 4 части 2 статьи 57, на 2011-2019 годы пунктом 6 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.СМИ Тогда
		РасшифровкаТариф = "Тариф установлен на 2011-2014 годы для страхователей, удовлетворяющих условиям пункта 7 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.НекоммерческиеОрганизации Тогда
		РасшифровкаТариф = "Тариф установлен на 2012-2013 годы для некоммерческих организаций пунктом 11 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.БлаготворительныеОрганизации Тогда
		РасшифровкаТариф = "Тариф установлен на 2012-2013 годы для благотворительных организаций пунктом 12 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ОрганизацииОказывающиеИнжиниринговыеУслуги Тогда
		РасшифровкаТариф = "Тариф установлен на 2012-2013 годы для организаций, оказывающих инжиниринговые услуги, пунктом 13 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ИндивидуальныйПредпринимательПрименяющийПатент Тогда
		РасшифровкаТариф = "Тариф установлен на 2013 год для индивидуальных предпринимателей, применяющих патент, пунктом 14 части 1 статьи 58 Федерального закона от 24 июля 2009 г. № 212-ФЗ"
	Иначе
		РасшифровкаТариф = "Тариф не указан"
	КонецЕсли;
	
	Возврат РасшифровкаТариф	
...
Функция ПредставлениеВидаДоходаПоСтраховымВзносам(ВидДохода) Экспорт
	...
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.МатпомощьПрокуроров Тогда
		РасшифровкаВидДохода = "Облагается страховыми взносами в ФОМС и ФСС частично (пункт 11 части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ), не облагаются страховыми взносами в ПФР (пункт 1 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.МатпомощьПриРожденииРебенка Тогда
		РасшифровкаВидДохода = "Облагается страховыми взносами в ФОМС и ФСС частично (подпункт в) пункта 3 части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.МатпомощьПриРожденииРебенкаПрокуроров Тогда
		РасшифровкаВидДохода = "Облагается страховыми взносами в ПФР, ФОМС и ФСС частично (подпункт в) пункта 3 части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ), не облагаются страховыми взносами в ПФР (пункт 1 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	...
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.НеОблагаетсяЦеликомПрокуроров Тогда
		РасшифровкаВидДохода = "Доходы прокуроров, следователей и судей, целиком не облагаемые страховыми взносами в ПФР, ФОМС и ФСС на основании части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ (кроме пособий по социальному страхованию за счет ФСС и частично облагаемой материальной помощи)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.НеЯвляетсяОбъектом Тогда
		РасшифровкаВидДохода = "Не является объектом обложения страховыми взносами в ПФР, ФОМС и ФСС в соответствии с частями 3 и 4 статьи 7 Федерального закона от 24 июля 2009 года № 212-ФЗ." + Символы.ПС + "Внимание! Эти суммы не будут включены в отчетность по страховым взносам."
