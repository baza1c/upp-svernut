...
Процедура ФормаЭлементаПриОткрытии(ЭтаФорма) Экспорт
	...
	ЭлементыФормы.ПанельСтраховыеВзносы.Свертка = ?(ЕстьЛетчики Или ЕстьШахтеры Или ЕстьФармацевты Или ЕстьРаботыСДосрочнойПенсией, РежимСверткиЭлементаУправления.Нет, РежимСверткиЭлементаУправления.Верх);
