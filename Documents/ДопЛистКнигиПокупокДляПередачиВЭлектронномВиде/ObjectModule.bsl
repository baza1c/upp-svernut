...
Процедура ЗаполнитьДаннымиТабличнойЧасти(Параметры, ДеревоВыгрузки)
	...
	Для Каждого СтрокаТабличнойЧасти Из ТабличнаяЧасть Цикл
		...
		Если СтрокаТабличнойЧасти.СуммаБезНДС5 <> 0 ИЛИ СтрокаТабличнойЧасти.НДС5 <> 0 Тогда
			НовыйУзелВтчСтоимПок = ПродублированныйУзелОбразец(ОбразецУзлаВтчСтоимПок);
			ЗаполнитьДаннымиПоСтавкеНДС(НовыйУзелВтчСтоимПок, "5", СтрокаТабличнойЧасти.СуммаБезНДС5, СтрокаТабличнойЧасти.НДС5);
			УдалятьОбразецУзлаВтчСтоимПок = Истина;
		КонецЕсли;
		...
		Если СтрокаТабличнойЧасти.СуммаБезНДС7 <> 0 ИЛИ СтрокаТабличнойЧасти.НДС7 <> 0 Тогда
			НовыйУзелВтчСтоимПок = ПродублированныйУзелОбразец(ОбразецУзлаВтчСтоимПок);
			ЗаполнитьДаннымиПоСтавкеНДС(НовыйУзелВтчСтоимПок, "7", СтрокаТабличнойЧасти.СуммаБезНДС7, СтрокаТабличнойЧасти.НДС7);
			УдалятьОбразецУзлаВтчСтоимПок = Истина;
		КонецЕсли;
