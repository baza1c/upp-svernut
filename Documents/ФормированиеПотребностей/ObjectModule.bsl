...
Функция ВыполнитьВыборкуДанных() Экспорт
	...
	Если ТипЗнч(НовыеПотребности) = Тип("ТаблицаЗначений") Тогда
	   ...
	   //+Лео ZAA
	   Если НЕ Лео_ОтключитьОстатки тогда
		 СкорректироватьПотребности(НовыеПотребности);
	   КонецЕсли;
	   //-Лео ZAA
		...
		Если мИспользоватьРазузлование Тогда
			...
			Если Строка.ВидВоспроизводства = Перечисления.ВидыВоспроизводстваНоменклатуры.Производство Тогда
					...
					//+Лео ZAA
					Если Лео_ПлановаяСпецификация тогда
						...
						МассивОшибок = абс_Дистрибуция._пРазузловатьНоменклатуру(ИсхПараметры, Результат, Параметры);
					иначе
						МассивОшибок = РазузлованиеНоменклатуры.РазузловатьНоменклатуру(ИсхПараметры, Результат, Параметры);
					Конецесли;	
					//-Лео ZAA
					...
					Если Результат <> Неопределено Тогда
						...
						//	сообщить(СтрокаРазузлования.Номенклатура);
						//	сообщить(СтрокаРазузлования.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент);
						//сообщить(СтрокаРазузлования.Номенклатура.ЕдиницаХраненияОстатков);
