Функция ПолучитьИтогиЗаПериодКнигаПродаж(СтруктураПараметров) Экспорт
	...
	|	ДополнительныйЛистКнигиПродаж.СуммаБезНДС5,
	|	ДополнительныйЛистКнигиПродаж.НДС5,
	|	ДополнительныйЛистКнигиПродаж.СуммаБезНДС7,
	|	ДополнительныйЛистКнигиПродаж.НДС7,
	...
	|	КнигаПродаж.НДС20,  
	|	КнигаПродаж.СуммаБезНДС5,
	|	КнигаПродаж.НДС5,
	|	КнигаПродаж.СуммаБезНДС7,
	|	КнигаПродаж.НДС7,
	...
	|	КнигаПродажЗаКорректируемыйПериод.СуммаБезНДС5,
	|	КнигаПродажЗаКорректируемыйПериод.НДС5,
	|	КнигаПродажЗаКорректируемыйПериод.СуммаБезНДС7,
	|	КнигаПродажЗаКорректируемыйПериод.НДС7,
