	...
	Если ЗначениеЗаполнено(Физлицо) Тогда
		...
		Для каждого СтрокаТЗРезультатов Из ТЗРезультатов Цикл
			...
			Если КомментироватьРасчет И Не СтрокаТабличнойЧасти.Сторно Тогда
				...
				ОбщегоНазначенияЗК.КомментарийРасчета("Остаток основного долга на конец месяца составил: " + ТЗКомментария[ТЗКомментария.Количество() - 2].ОсновнойДолгКонечныйОстаток, КомментарийДоговора,,,, Истина);
