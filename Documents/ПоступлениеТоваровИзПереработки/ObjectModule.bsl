...
Функция ПечатьМ4()
	...
	//{Лео Катанович
	//ИГК
	ИГК = Шапка.Договорконтрагента.Лео_ИГК;	
...
Процедура ДвиженияПоРегистрам(РежимПроведения, СтруктураШапкиДокумента, ТаблицаПоТоварам, ТаблицаОтходы, ТаблицаПоТаре, Отказ, Заголовок)
	...
	//АБС ВСТАВКА Делаем движения по регистру ТоварыОрганизаций  27.03.2014 9:58:20  Фролов
	ДвиженияПоРегиструТоварыОрганизаций(РежимПроведения, СтруктураШапкиДокумента, ТаблицаПоТоварам, Отказ, Заголовок);
	//АБС ВСТАВКА Делаем движения по регистру ТоварыОрганизаций КОНЕЦ 
...
//АБС ВСТАВКА ТоварыОрганизаций  27.03.2014 9:57:27  Фролов
Процедура ДвиженияПоРегиструТоварыОрганизаций(РежимПроведения, СтруктураШапкиДокумента, ТаблицаПоТоварам, Отказ, Заголовок)
	...
	Иначе
		ТаблицаДвижений.ЗаполнитьЗначения(СкладОрдер, "Склад");
	КонецЕсли;
...
КонецПроцедуры
//АБС ВСТАВКА ТоварыОрганизаций КОНЕЦ 
...
Процедура ОбработкаЗаполнения(Основание)
	...
	//АБС ВСТАВКА Замечание 120  15.05.2014 9:18:50  Балашенко
	Организация = Константы.абс_ОрганизацияЛеовит.Получить();
	ВидПоступления = Перечисления.ВидыПоступленияТоваров.НаСклад;
	СкладОрдер = Константы.абс_СкладКарантина.Получить();
	//АБС ВСТАВКА Замечание 120 КОНЕЦ
