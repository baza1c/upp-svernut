...
Функция ПечатьСчетаФактуры(МассивОбъектов, ОбъектыПечати)
	...
	Для каждого Ссылка Из МассивОбъектов Цикл
		...
		//АБС ИЗМЕНЕНИЕ Вывод колонтитула  31.05.2014 17:44:31  Балашенко
		...
		Если ВыводитьКолонтитул Тогда
			...
			ТабДокумент.ВерхнийКолонтитул.ТекстСправа  = ЗаголовокДляПечати;
			ТабДокумент.ВерхнийКолонтитул.ТекстВЦентре = "Страница [&НомерСтраницы] из [&СтраницВсего]";
		КонецЕсли;
		//АБС ИЗМЕНЕНИЕ Вывод колонтитула КОНЕЦ
