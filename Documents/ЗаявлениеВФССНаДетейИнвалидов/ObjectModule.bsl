...
Процедура Автозаполнение() Экспорт
	...
	|	ВЫРАЗИТЬ(ВЫБОР
	|			КОГДА ПолучателиПособия.СуммированныйУчетРабочегоВремени
	|				ТОГДА ВЫБОР
	|						КОГДА ДанныеСреднегоЗаработка.ОтработаноЧасов = 0
	|							ТОГДА 0
	|						ИНАЧЕ ДанныеСреднегоЗаработка.СреднийЗаработок / ДанныеСреднегоЗаработка.ОтработаноЧасов
	|					КОНЕЦ
	|			ИНАЧЕ ВЫБОР
