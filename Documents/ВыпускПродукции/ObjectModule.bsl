...
Процедура ДвиженияПоРегистрам(РежимПроведения, СтруктураШапкиДокумента, ТаблицаПоПродукции, Отказ, Заголовок)
	...
	//АБС 
	абс_ДвиженияПоРегиструВыпускПродукции(ТаблицаПоПродукции);
	//\\АБС
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	//АБС ВСТАВКА Замечание 118  13.05.2014 12:24:24  Балашенко
	Организация = Константы.абс_ОрганизацияЛеовит.Получить();
	Склад = Константы.абс_СкладГП.Получить();
	//АБС ВСТАВКА Замечание 118 КОНЕЦ
...
Процедура абс_ДвиженияПоРегиструВыпускПродукции(ТаблицаПоПродукции)
	ТаблицаВыпуска = ТаблицаПоПродукции.Скопировать();
	ТаблицаВыпуска.Колонки.Номенклатура.Имя = "Продукция";
	ТаблицаВыпуска.Колонки.ХарактеристикаНоменклатуры.Имя = "ХарактеристикаПродукции";
	ТаблицаВыпуска.Колонки.СерияНоменклатуры.Имя = "СерияПродукции";
	ТаблицаВыпуска.Колонки.ЗаказПокупателя.Имя = "Заказ";
	ТаблицаВыпуска.Колонки.Добавить("ДокументВыпуска");
	ТаблицаВыпуска.Колонки.Добавить("Период");
	ТаблицаВыпуска.Колонки.Добавить("Активность");
	ТаблицаВыпуска.ЗаполнитьЗначения(ЭтотОбъект.Ссылка, "ДокументВыпуска");
	
	Движения.ВыпускПродукции.мПериод = Дата;
	Движения.ВыпускПродукции.мТаблицаДвижений = ТаблицаВыпуска;
	Движения.ВыпускПродукции.ДобавитьДвижение();
КонецПроцедуры		
